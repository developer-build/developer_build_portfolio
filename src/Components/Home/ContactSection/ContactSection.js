...
const ContactSection = () => {
  const sendEmail = (event) => {
    ...
    emailjs.sendForm('service_7mf71pq', 'template_27r7boq', event.target, '8WjOhkzB5Rv7JRs02')
      .then((result) => {
  ...
  return <div>
    <div className="container mx-auto">
      ...
      <p className="text-center text-gray-400 container mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero, ullam dolore quae commodi repellendus quam eum delectus laborum doloribus unde quos placeat beatae in sequi optio. Tempora blanditiis praesentium</p>

    </div>
    <div className="mx-3">
      <div className="mx-auto contact-container m-3">
    ...
    <div className="contact-container mx-auto mt-5 p-2">
